...
window.addEventListener("DOMContentLoaded", function(event) {
  ...
  //const apiClient = new ApiAi.ApiAiClient({accessToken: '329dcb8e2a8f4876acbf7fb616978686'});
	// 702b1dad8a9743d2911a09f1bf414837
	const apiClient = new ApiAi.ApiAiClient({accessToken: '702b1dad8a9743d2911a09f1bf414837'});
  // Initial feedback message.
  addBotItem("Hi! I’m edi. Tap the microphone and start talking to me.");
